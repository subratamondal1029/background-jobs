...
def generate_preview(
    ...
    try:
        ...
        database_service.update_job_status(data["jobId"], "PROCESSING")
        time.sleep(5)
        ...
        database_service.update_job_status(data["jobId"], "SUCCESS")
        # TODO: send to status queue
        ...
        database_service.update_job_status(
            data["jobId"], "RETRYING", error=str(e), retries=retry_count + 1
        )
        channel.basic_ack(delivery_tag=method.delivery_tag)
